            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni Üstünlük</h4>
                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="2" name="{{ $lang }}_text">{{ old($lang . '_text') }}</textarea>
                                                @error("{$lang}_text")
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="type" required>
                                        <option value="admin" {{ old('type') == 'admin' ? 'selected' : '' }}>Administratorlar və Sahiblər üçün</option>
                                        <option value="tenant" {{ old('type') == 'tenant' ? 'selected' : '' }}>Kirayəçilər üçün</option>
                                    </select>
                                </div>
                                <div class="mb-3">
