                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('name') }}" name="name" placeholder="Partner adı (opsional)">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="url" value="{{ old('link') }}" name="link" placeholder="https://example.com">
                                    @error('link')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label">Partner Loqosu <span class="text-danger">*</span></label>
