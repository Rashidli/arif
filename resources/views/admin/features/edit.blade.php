            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Xüsusiyyət Redaktə</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('features.index') }}">Xüsusiyyətlər</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old($lang . '_name', $feature->translate($lang)->name ?? '') }}" name="{{ $lang }}_name" placeholder="Xüsusiyyət adı...">
                                                        @error("{$lang}_name")
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="{{ $lang }}_description" placeholder="Xüsusiyyət açıqlaması...">{{ old($lang . '_description', $feature->translate($lang)->description ?? '') }}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if($feature->image)
                                    <div class="mb-3">
                                        <img src="{{ asset('storage/' . $feature->image) }}" alt="" style="max-width: 100%; height: auto; border-radius: 4px;">
                                    </div>
                                @endif
                                <div class="mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1" {{ $feature->status ? 'checked' : '' }}>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('features.index') }}" class="btn btn-outline-secondary">Geri</a>
                                </div>
                            </div>
                        </div>
                    </div>
