            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni Xüsusiyyət</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="{{ old($lang . '_name') }}" name="{{ $lang }}_name" placeholder="Xüsusiyyət adı...">
                                                        @error("{$lang}_name")
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="{{ $lang }}_description" placeholder="Xüsusiyyət açıqlaması...">{{ old($lang . '_description') }}</textarea>
