...
<head>
    ...
    <meta content="Binaplus" name="author"/>
    <!-- App favicon -->
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{ route('contact_items.index') }}">Contact Info</a></li>
                            <li><a href="{{ route('socials.index') }}">Social Networks</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{ route('words.index') }}">Translations</a></li>
                        </ul>
                    </li>
