...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Əsas Bölmə (Hero)</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item">Bizi tövsiyyə edənlər</li>
                                <li class="breadcrumb-item active">Əsas Bölmə</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('recommend.hero.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-8">
                                ...
                                <div class="tab-content">
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Tag (kiçik mətn) </label>
                                                <input class="form-control" type="text" value="{{ old($lang . '_subtitle', $section?->translate($lang)?->subtitle ?? '') }}" name="{{ $lang }}_subtitle" placeholder="Bizi Seçirlər...">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="6" name="{{ $lang }}_description">{{ old($lang . '_description', $section?->translate($lang)?->description ?? '') }}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1" {{ ($section?->status ?? true) ? 'checked' : '' }}>
