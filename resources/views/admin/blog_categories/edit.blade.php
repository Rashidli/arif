...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            <h4 class="mb-0">Kateqoriya Redaktə</h4>
                            <a href="{{ route('blog_categories.index') }}" class="btn btn-sm btn-outline-primary">
            ...
            <form action="{{ route('blog_categories.update', $blog_category->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-8">
                                    ...
                                    @foreach(['az', 'en', 'ru'] as $lang)
                                        <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang }}" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="{{ $lang }}_name" value="{{ old($lang . '_name', $blog_category->translate($lang)->name ?? '') }}">
                                                @error("{$lang}_name")
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1" {{ $blog_category->status ? 'checked' : '' }}>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="show_on_home" value="1" {{ $blog_category->show_on_home ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" name="home_order" value="{{ old('home_order', $blog_category->home_order ?? 0) }}" min="0">
